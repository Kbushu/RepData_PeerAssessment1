...
*  The mean total number of steps per day is `r format(signif(steps.day.impute.mean,6),big.mark = ",")` steps, indicated as red line on the histogram.

*  The median total number of steps per day is `r format(signif(steps.day.impute.median,6),big.mark = ",")` steps, indicated by the green line on the histogram.
